    ...
    listas.forEach(lista =>{
            ...
            if (mi_estatus == "Inicio"){
                ...
                <tr elmentoid="${lista.id_inci}">                    
                    ...
                    <td><img style="width: 150px;" src="../../backend/img_insi/${lista.foto_in}" id="img_in" alt="" onerror="this.src='https://www.hostalterra.com.ec/gestion/imagenes/sin_imagen.jpg';></td>
                    <td>${lista.status}</td>
